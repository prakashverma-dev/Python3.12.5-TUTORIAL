...
''' Some Other Data Strutures : -

i) Linked Lists : - It the special type of user-defined datatype, It consists of elements tht are connected or linked with each other with 'Poiter'.
...
# ii) Stack DA : Imagine Somehting stored one upon another order like book stored one by one.
...
iii) Queue DA : Imagine People standing in queue for movie tickets, atm, or in market.
...
iv) Tree DA : It is also one of the user-defined DA. think about a tree having root and leaves. Here, In Tree DA, a root represents a data.
...
v) Graph DA : think Graph like a connected Data. Graph DA also have Nodes and Edges(Sides).
